...
<html lang="pt-br">
	...
	<body id="body">
		<script>
			...
			h.appendChild( document.createTextNode("Número de escolas urbanas por município") );
			...
			require([
				  ...
				  Layer.fromPortalItem({
		        	portalItem: {         // autocast as esri/portal/PortalItem
		          		id: "bde3f6322b35485e9de77e842215478d"
		       		}
			...
			function fncMunicipios(response){
			    ...
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Escolas Urbanas" ));
			    tr.appendChild(th);
			    ...
			    var p = document.createElement("p");
			    p.appendChild( document.createTextNode("* Dados de") );
