...
<html lang="pt-br">
	...
	<body id="body">
		<script>
			...
			h.appendChild( document.createTextNode("Plataformas de Petróleo e Gás") );
			...
			require([
				  ...
				  "esri/layers/Layer",
				  "dojo/domReady!"
				], function(Map, MapView, Layer) { // Layer
				  var map = new Map({
				  ...
				  Layer.fromPortalItem({
		        	portalItem: {         // autocast as esri/portal/PortalItem
		          		id: "af7706a0444f47a8b835113c1e742753"
		       		}
			...
			function fncMunicipios(response){
			    ...
			    th.appendChild(document.createTextNode( "Operadora" ));
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Estado" ));
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Profundidade Média (m)" ));
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Espessura da Lâmina (m)" ));
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Resultado" ));
			    tr.appendChild(th);
