...
<html lang="pt-br">
	...
	<body id="body">
		<script>
			...
			h.appendChild( document.createTextNode("Municípios com Backbone em fibra óptica") );
	  		...
	  		require([
				  ...
				  Layer.fromPortalItem({
		        	portalItem: { // autocast as esri/portal/PortalItem
		          		id: "03104c0ef9e44fecac23cbb8e25b2010"
			...
			function fncBackboneFibra(response){
			    ...
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Backbone" ));
			    tr.appendChild(th);
			    ...
			    while( i<(sz-2) ){
			    	...
			    	var td = document.createElement("td");
			    	td.appendChild(document.createTextNode( "Fibra" ));
			    	tr.appendChild(td);
