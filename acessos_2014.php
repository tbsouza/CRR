...
<html lang="pt-br">
	<head>
		...
		<meta name="description" content="Acessos a Banda larga - 2014">
		<meta property="og:title" content="População 2014 - CRR">
		<meta property="og:image" content="crr_logo_pequeno.png">
		<meta property="og:description" content="Acessos a Banda larga no Brasil por Município em 2014.">
	...
	<body id="body" onload="onLoad()">
		...
		<!-- Titulo da pagina -->
		<h2> Acessos a Banda Larga - 2014 </h2>
...
//***************************************************************************************
			...
			function style0(feature) {
				...
				var pop = feature.properties.acessos;
...
<!-- *********************************************************************************************** -->
		...
		<script type="text/javascript">
			...
			var _coluna = "ACESSOS_2014"; // Variável que será passada para o php
