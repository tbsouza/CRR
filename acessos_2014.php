...
<html lang="pt-br">
	...
	<body id="body">
		<script>
			...
			h.appendChild( document.createTextNode("Acessos a Banda Larga") );
			...
			require([
				  ...
				  Layer.fromPortalItem({
		        	portalItem: {         // autocast as esri/portal/PortalItem
		          		id: "29cbfcd9bf40404ca8d053d7caf9dda1"
		       		}
			...
			function fncMunicipios(response){
			    ...
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Acessos" ));
			    tr.appendChild(th);
