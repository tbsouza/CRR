...
<html lang="pt-br">
	...
	<body id="body">
		<script>
			...
			h.appendChild( document.createTextNode("Número de escolas rurais por município") );
			...
			require([
				  ...
				  Layer.fromPortalItem({
		        	portalItem: {         // autocast as esri/portal/PortalItem
		          		id: "f8806e85ff11438f9bdf2e37a37c7b4e"
		       		}
			...
			function fncMunicipios(response){
			    ...
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "Escolas Rurais" ));
			    tr.appendChild(th);
