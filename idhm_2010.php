...
<html lang="pt-br">
	...
	<body id="body">
		<script>
			...
			h.appendChild( document.createTextNode("Índice de Desenvolvimento Humano Municipal - IDHM") );
			...
			require([
				  ...
				  Layer.fromPortalItem({
		        	portalItem: {         // autocast as esri/portal/PortalItem
		          		id: "3e3006b9e8514527bfd16cdf9bd0c7e7"
		       		}
			...
			function fncMunicipios(response){
			    ...
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "IDHM" ));
			    tr.appendChild(th);
