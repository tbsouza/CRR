...
<html lang="pt-br">
	...
	<body id="body">
		<script>
			...
			h.appendChild( document.createTextNode("População Rural do Brasil") );
			...
			require([
				  ...
				  Layer.fromPortalItem({
		        	portalItem: {         // autocast as esri/portal/PortalItem
		          		id: "9f93651bef1a4873a7c6358f146d841a"
		       		}
			...
			// ajax para consulta do banco
			$.ajax({
	      		url:'pop_rur_2010_bd.php',
			...
			function fncMunicipios(response){
			    ...
			    tr.appendChild(th);
			    var th = document.createElement("th");
			    th.appendChild(document.createTextNode( "População Rural" ));
			    tr.appendChild(th);
